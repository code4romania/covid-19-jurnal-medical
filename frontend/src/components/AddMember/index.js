...
const AddMember = () => {
  ...
  return (
    //TODO: remove common components when added to BasePage
    <BasePage>
      <Hero
        ...
        <div className="column is-8">
          <form>
            ...
            <p className="subtitle is-6">
              Spune-ne dacă suferă de anumte boli cronice, diabet,
              hipertensiune, etc
            </p>
            <Input label="" name="" />
            <Label text="Are anumite dizabilități?" />
            <p className="subtitle is-6">
              Spune-ne dacă sferă de anumite dizabilitati Ex locomotorii,
              mentale, de vorbire etc.
            </p>
        ...
        <aside className="column is-4">
          <Instruments layout="column">
            ...
            <InstrumentsItem
              ...
              content="Lorem ipsum dolorit sit amet, consecteur adipiscing elit. Elit, duis pretium"
