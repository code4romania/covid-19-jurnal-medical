...
export const Constants = {
  apiUrl: windowEnvironment.REACT_APP_API_URL || process.env.REACT_APP_API_URL,
  isDev:
  ...
  idpUrl: windowEnvironment.REACT_APP_IDP_URL || process.env.REACT_APP_IDP_URL,
  clientId: windowEnvironment.CLIENT_ID || process.env.CLIENT_ID,
  appUrl: windowEnvironment.REACT_APP_URL || process.env.REACT_APP_URL
};
